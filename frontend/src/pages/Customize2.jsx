    ...
    const handleUpdateAssistant = async () => {
        ...
        try {
            ...
            if (backendImage) {
                ...
                formData.append("imageUrl", selectedImage);  // ⭐ FIXED
            }
...
console.log("After update userData should be =", result.data);
    ...
    return (
        <div className='w-full h-[100vh] bg-gradient-to-t from-[black] to-[#030353] flex justify-center items-center flex-col p-[20px] relative '>
            ...
            {assistantName && <button className='min-w-[300px] h-[60px] mt-[30px] text-black font-semibold cursor-pointer  bg-white rounded-full text-[19px] ' disabled={loading} onClick={handleUpdateAssistant}
